...
$htmlContent = <<<HTML
<svg height="28" role="img" width="76.75" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <g shape-rendering="crispEdges">
        <rect fill="#555" height="28" id="contenedor" width="80.75" x="0"/>
    </g>
    <g fill="#fff" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" font-size="100" text-anchor="middle" text-rendering="geometricPrecision">
        <text fill="#fff" font-weight="bold" id="estado" textLength="567.5" transform="scale(.1)" x="370" y="175">...</text>
    </g>
</svg>
<style>
    body{margin:0}
...
function checkServerStatus(){
    $.getJSON("https://api.mcsrvstat.us/3/' . $ip . '",function(e){
        if(0==e.online)$("#estado").text("OFFLINE"),$("#contenedor").css("fill","#e05d44");
        else{
            e.players.online;
            1==e.players.online&&"",null==e.icon?($("#estado").text("OFFLINE"),$("#contenedor").css("fill","#e05d44")):($("#estado").text("ONLINE"),$("#contenedor").css("fill","#4c1"))
        }
    });
}
checkServerStatus();
